            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<#if (imageList?size > 0)>
                                <span class="jqzoom"><img width="400" height="400" jqimg="${imageList[0].url}"
                        ...
                        <#-- <dd><a href="javascript:;" class="selected">金色<span title="点击取消选择">&nbsp;</span>
                         ...
                         <dd><a href="javascript:;">黑色</a></dd>-->
                            <#list spec.attributeValue as option>
                                <dd><a @click="selectSpecification('${spec.attributeName}','${option}')"
                                       href="javascript:;"
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input v-model="num" autocomplete="off" type="text" value="1" minnum="1"
                                           class="itxt"/>
                                    <a @click="addNum(num)" href="javascript:void(0)" class="increment plus">+</a>
                                    <a @click="subtractNum(num)" href="javascript:void(0)" class="increment mins">-</a>
                                </div>
                            </div>
                        </div>
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;" @click="addToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
