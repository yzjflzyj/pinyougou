        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img width="100%" height="100%" jqimg="${seckillGoods.smallPic!}"
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news">
                    ...
                    <span class="overtime">{{allsecond}}距离结束：{{secondStr}}</span>
                </div>
                <div class="summary">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;" @click="submitOrder()"
                                       class="sui-btn  btn-danger addshopcar" >{{btnSubmit}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="tab-main intro">
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            ...
                            <div class="intro-detail">${seckillGoods.introduction!}</div>
                        </div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            startTimer: function () {
                ...
                let end = new Date(this.endTime).getTime();  //结束时间
                //时间差，总秒数
                this.allsecond = Math.floor((end - now) /1000);*/
                //跟据商品ID查看库存与活动剩余秒数
                axios.get("/seckillGoods/getGoodsInfoById.do?id=" + this.seckillId).then(function (response) {
                    //总秒数
                    app.allsecond = response.data.allsecond;
                    //库存数
                    app.stockCount = response.data.count < 0 ? 0 : response.data.count;
                });
            ...
            submitOrder: function () {
                ...
                axios.get("/seckillOrder/submitOrder.do?seckillId=" + this.seckillId).then(function (response) {
                    ...
                    if (response.data.success) {
                        axios.get("/seckillOrder/getQueueStatus.do?seckillId=" + app.seckillId).then(function (resp) {
                            //输出排队结果
