!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        n.r(e);
        var o = n(2), i = n.n(o), s = n(3), r = n.n(s), a = n(0), l = n.n(a), u = {
            watch: {
        ...
        function p(t, e, n, o, i, s, r, a) {
            ...
            if (e && (u.render = e, u.staticRenderFns = n, u._compiled = !0), o && (u.functional = !0), s && (u._scopeId = "data-v-" + s), r ? (l = function (t) {
        ...
        var d = {
            components: {
                ...
                select: function (t) {
                    ...
                    var e = [this.$el, this.searchEl, this.$refs.toggle.$el, this.$refs.openIndicator.$el].concat(i()(Array.from(this.$refs.openIndicator.$el.children))),
                        n = t.target;
                    (e.includes(n) || n.classList.contains("vs__selected")) && (this.open ? this.searchEl.blur() : this.disabled || (this.open = !0, this.searchEl.focus()))
            ...
            return n("div", {
                ...
                ref: "toggle", staticClass: "vs__dropdown-toggle", on: {
            ...
            }), t._v(" "), t._t("search", [n("input", t._g(t._b({staticClass: "vs__search"}, "input", t.scope.search.attributes, !1), t.scope.search.events))], null, t.scope.search)], 2), t._v(" "), n("div", {staticClass: "vs__actions"}, [n("button", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
            ...
            }, [n("deselect")], 1), t._v(" "), t.noDrop ? t._e() : n("open-indicator", {
                ref: "openIndicator",
                ...
                attrs: {role: "listbox"},
                on: {mousedown: t.onMousedown, mouseup: t.onMouseUp}
        ...
        }, [], !1, null, null, null).exports), y = {ajax: h, pointer: c, pointerScroll: u};
